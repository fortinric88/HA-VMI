...
class DataParser:
    ...
    def parse_vmi_status(self, data):
        """
        Parse VMI operating mode from status byte
        
        Args:
            data: Status byte value
        
        Returns:
            String description of operating mode
        """
        modes = {
            0: 'Off',
            1: 'Low',
